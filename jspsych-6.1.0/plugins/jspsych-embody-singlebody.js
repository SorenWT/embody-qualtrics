jsPsych.plugins["embody-singlebody"] = (function(){
    ...
    plugin.trial = function(display_element, trial){
        ...
        var pbox_html = '<div id="pbox" style="position:relative; touch-action:none; user-select:none;">'+
            //'<div id="pbox1" style="float:left;background-image:url('+silimage+');"></div>'+
            '<div id="pbox1"><img src="'+repo_site+'v1/images/dummyG_small.png"></img></div>'+
        ...
        var label_html = '<div id="labels"><p><strong>Sensations '+trial.senstype+'</strong></p>';
