...
var instructions2 = {
    ...
    '<div style="width:34%; max-height: 100%; float:right;"><img src="embody/v1/images/examples/example_upper.png" style="max-width:49%; max-height:100%;"></img><img src="embody/v1/images/examples/example_lower.png" style="max-width:49%; max-height:100%;"></img></div></div><br>'+
    ...
    '<div style="width:34%; float:right"><img src="'+repo_site+'v1/images/examples/example_intense.png" style="max-width:49%; max-height:100%;"></img><img src="embody/v1/images/examples/example_weak.png" style="max-width:49%; max-height:100%;"></img></div></div><br>'+
    ...
    '<div style="width:34%; float:right"><img src="'+repo_site+'/v1/images/examples/example_concentrated.png" style="max-width:49%; max-height:100%;"></img><img src="embody/v1/images/examples/example_diffuse.png" style="max-width:49%; max-height:100%;"></img></div></div><br>'+
